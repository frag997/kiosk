...
import {
  BotCustomSidebar,
  BotFormComponent,
} from "./Containers/botControllerContainer";
import {
  CalendarContainer,
  CalendarToolbar,
} from "./Containers/calendarContainer";
import {
  FluidSimulatorContainer,
  FluidSimulatorsSidebar,
} from "./Containers/fluidSimulatorContainer";
...
function App() {
  ...
  const tabs = [
    ...
    },
    {
      ...
      sidebar: (
        <div>
          <FluidSimulatorsSidebar values={fluidConfig} hooks={setFluidConfig} />
        </div>
      ),
    },
  ];
  const sidebar = tabs[activeTab].sidebar;
  return (
    <Layout>
